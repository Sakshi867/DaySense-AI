...
const DashboardSidebar: React.FC<DashboardSidebarProps & { isMobile?: boolean, isOpen?: boolean, onClose?: () => void }> = ({
  collapsed = false,
  onToggle,
  isMobile = false,
  isOpen = false,
  ...
  const sidebarClasses = cn(
    'fixed left-0 top-0 h-screen glass border-r border-border/50 z-50',
    ...
    <>
      ...
      <aside className={sidebarClasses}>
        ...
        <div className={cn(
          ...
          {isMobile && (
            <button onClick={onClose} className="p-2 hover:bg-accent/50 rounded-lg">
